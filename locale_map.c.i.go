...
var _cgos_envvars_locale_map [6][12]int8 = [6][12]int8{[12]int8{'L', 'C', '_', 'C', 'T', 'Y', 'P', 'E', '\x00'}, [12]int8{'L', 'C', '_', 'N', 'U', 'M', 'E', 'R', 'I', 'C', '\x00'}, [12]int8{'L', 'C', '_', 'T', 'I', 'M', 'E', '\x00'}, [12]int8{'L', 'C', '_', 'C', 'O', 'L', 'L', 'A', 'T', 'E', '\x00'}, [12]int8{'L', 'C', '_', 'M', 'O', 'N', 'E', 'T', 'A', 'R', 'Y', '\x00'}, [12]int8{'L', 'C', '_', 'M', 'E', 'S', 'S', 'A', 'G', 'E', 'S', '\x00'}}
	...
	if !(*val != 0) {
		if !(func() (_cgo_ret *int8) {
			...
			*_cgo_addr = Getenv((*int8)(unsafe.Pointer(&[7]int8{'L', 'C', '_', 'A', 'L', 'L', '\x00'})))
			...
			_cgo_addr := &val
			*_cgo_addr = Getenv((*int8)(unsafe.Pointer(&*(*[12]int8)(unsafe.Pointer(uintptr(unsafe.Pointer((*[12]int8)(unsafe.Pointer(&_cgos_envvars_locale_map)))) + uintptr(cat)*12)))))
			return *_cgo_addr
		}() != nil && int32(*val) != 0 || func() (_cgo_ret *int8) {
			_cgo_addr := &val
